...
pandoc content/supplementary_file/supplementary_file.md --lua-filter=content/supplementary_file/scholarly-metadata.lua --lua-filter=content/supplementary_file/author-info-blocks.lua --pdf-engine=weasyprint -o output/supplementary_file.pdf
