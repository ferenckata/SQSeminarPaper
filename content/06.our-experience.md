...
A project, where we extensively applied software quality features when working on the same collection code as a team was the latest release of JASPAR database [@doi:10.1093/nar/gkad1059].
From this project experience we concluded that continuous integration is yet to be conquered, but code reviews turned out to be a driver of efficient and quality software development.
