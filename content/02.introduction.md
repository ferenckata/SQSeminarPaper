...
Finally, we describe and discuss how our research groups, motivated and inspired by current software quality state, created weekly sessions to practically discuss and learn to incorporate different aspects of software quality.
We find that good practices require investment in time and effort that may not feasible to fulfill as an individual (e.g. having limited time to perform and to deliver doctoral thesis).
