...
It is unrealistic to expect that a bioinformatician on temporary contract, working towards publishing, without formal training in computer science, or institutional support would be able to learn and implement all of them.
To ease this pressure, Arvanitou et al. note that a scientific software developer needs to prioritize the software quality attributes to make choices among the good practices [@doi:10.1016/j.jss.2020.110848].
They also provide a matrix to help with the selection and priorization.
An issue might be, as mentioned above, is that bioinformaticians are rarely familiar with the meaning and importance of software quality attributes [@{https://iso25000.com/index.php/en/iso-25000-standards/iso-25010?limit=3%20}].
